        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentType = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    DriverImg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServicesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HService1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DService1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HService2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DService2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HService3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DService3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
